...
open class Answer(val text: String, val influence: List<Church> = emptyList(), val important: Int = 1)
data class Question(val question: String, val answers: List<Answer> = emptyList(), val display: Boolean = true, val ignore: Boolean = false, val slider : Boolean = true)
...
fun getQuestions(): List<Question> =
        listOf(
                ...
                ), display = false, ignore = true, slider = false),
