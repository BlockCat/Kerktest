...
fun getQuestions(): List<Question> =
        listOf(
            Question("Hoe denkt u over God?", listOf(
                    Answer("Er is één persoonlijke God, de Drie-eenheid van Vader, Zoon en Heilige Geest.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Er is één persoonlijke God, maar Hij is geen Drie-eenheid.", listOf(MODERN_GEREFORMEERD)),
                    Answer("Er is één God, die niet noodzakelijk een persoon is. ", listOf(VRIJZINNIG)),
                    Answer("Geen mening.", listOf()))),
            Question("Hoe denkt u over de Bijbel?", listOf(
                    Answer("De Bijbel is het gezaghebbende Woord van God en op alle terreinen volledig betrouwbaar.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe denkt u over Jezus?", listOf(
                    Answer("Jezus was volkomen God en volkomen mens.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe denkt u over de opstanding van Jezus?", listOf(
                    Answer("Jezus is lichamelijk opgestaan uit de doden.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe wordt een mens gered?", listOf(
                    ...
                    Answer("God biedt aan iedereen zijn genade aan. Een mens wordt gered wanneer hij er uit vrije wil voor kiest om dit geschenk te aanvaarden en gelooft dat Jezus Christus voor zijn zonden gestorven is.", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
                    ...
                    Answer("Geen mening.", listOf()))),
            Question("Hoe denkt u over uitverkiezing?", listOf(
                    Answer("God heeft van tevoren sommige mensen naar eigen wil uitverkoren en alleen die mensen zullen gered worden. ", listOf(ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD)),
                    Answer("Elk mens kan uit vrije wil kiezen om Gods genade te aanvaarden en op die manier gered worden.", listOf(KATHOLIEK, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Ieder mens is een kind van God en zal uiteindelijk gered worden.", listOf(MODERN_GEREFORMEERD, VRIJZINNIG)),
                    Answer("Geen mening.", listOf()))),
            Question("Waarop moet volgens u in een preek de grootste nadruk liggen?", listOf(
                    ...
                    Answer("Hoe een mens tot eer van God kan leven.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe denkt u over de Drie Formulieren van Enigheid (Heidelbergse Catechismus, Nederlandse Geloofsbelijdenis en Dordtse Leerregels)?", listOf(
                    ...
                    Answer("Deze spelen geen rol.", listOf(KATHOLIEK, MODERN_GEREFORMEERD, VRIJZINNIG, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over muziek in de kerk?", listOf(
                    ...
                    Answer("De liedcultuur in de kerk moet goed aansluiten op de mens van vandaag. Dat kan het best wanneer de nadruk ligt op moderne liedjes, bij voorkeur onder begeleiding van een worshipband.", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over de doop?", listOf(
                    Answer("Iemand mag pas gedoopt worden als hij/zij bewust gelooft.", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe denkt u over vrouwen in het ambt?", listOf(
                    ...
                    Answer("Vrouwen behoren geen predikant/pastoor te worden, maar mogen wel ouderling/oudste zijn.", listOf(ORTHODOX_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Hoe denkt u over de organisatie van de kerk?", listOf(
                    Answer("Lokale kerken moeten in grote mate zelfstandig zijn.", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("In welke mate moet traditie in de kerk een rol spelen?", listOf(
                    ...
                    Answer("In zo klein mogelijke mate.", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over de aanwezigheid van Christus in avondmaal/eucharistie?", listOf(
                    ...
                    Answer("Christus is geestelijk aanwezig in de gelovigen. Het brood en de wijn zijn puur symbolisch.", listOf(VRIJZINNIG, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over het deelnemen van kinderen aan avondmaal/eucharistie?", listOf(
                    ...
                    Answer("Kinderen mogen deelnemen, maar pas vanaf een bepaalde leeftijd.", listOf(KATHOLIEK, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Kinderen mogen deelnemen vanaf het moment dat ze dat zelf willen.", listOf(MODERN_GEREFORMEERD, VRIJZINNIG, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over hemel en hel?", listOf(
                    Answer("Er bestaan een hemel en een hel.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Alleen de hemel bestaat, en iedereen zal hier naartoe gaan.", listOf(MODERN_GEREFORMEERD, VRIJZINNIG)),
                    Answer("Alleen de hemel bestaat. Mensen die hier niet naartoe gaan, zullen worden vernietigd.", listOf(ALTERNATIEVE_STROMINGEN)),
                    Answer("Geen mening.", listOf())
            )),
            Question("Hoe denkt u over de rustdag?", listOf(
                    Answer("De rustdag is op zaterdag. Een christen behoort zich net als de joden te houden aan het vierde gebod: ‘Gedenk de sabbatdag, dat u die heiligt.’ ", listOf(ALTERNATIEVE_STROMINGEN)),
                    ...
                    Answer("Een christen hoeft zich niet aan een rustdag te houden, maar het is wel een goed idee om een dag in de week uit te rusten.", listOf(MODERN_GEREFORMEERD, VRIJZINNIG, CHARISMATISCH, NIET_CHARISMATISCH)),
                    Answer("Geen mening", listOf())
            )),
            Question("Hoe denkt u over bijzondere gaven van de Geest zoals profeteren, tongentaal en wonderbaarlijke genezingen?", listOf(
                    ...
                    Answer("Deze gaven komen nog steeds voor, maar niet meer zo vaak als in de vroege kerk. ", listOf(MODERN_GEREFORMEERD, ORTHODOX_GEREFORMEERD, NIET_CHARISMATISCH)),
            ...
            Question("Moet er in preken veel nadruk worden gelegd op persoonlijke bekering?", listOf(
                    ...
                    Answer("Ja, de kerk moet evangeliserende preken hebben die toegankelijk zijn voor niet-christenen. ", listOf(CHARISMATISCH, NIET_CHARISMATISCH)),
            ...
            Question("Moet er in preken veel nadruk worden gelegd op de eindtijd?", listOf(
                    Answer("Ja, want de kans is groot dat de eindtijd nabij is.", listOf(CHARISMATISCH, ALTERNATIEVE_STROMINGEN)),
                    Answer("Nee, dit is slechts een van de vele thema’s waar preken over zouden moeten gaan.", listOf(KATHOLIEK, ORTHODOX_GEREFORMEERD, BEVINDELIJK_GEREFORMEERD, NIET_CHARISMATISCH)),
